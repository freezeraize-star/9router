# Custom Logic — Freezeraize (9router Fork)
...
## 9. Freezeraize Branding

### Files
- `src/app/layout.js` — Title: "Freezeraize - AI Infrastructure Management"
- `src/dashboardGuard.js` — API welcome: "Welcome to Freezeraize! Use {baseUrl}/v1 as your API endpoint."
...
| `src/app/layout.js` | Freezeraize branding + upstream GA/font script |
