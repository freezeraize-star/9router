<div align="center">
  ...
  **Conecte todas as ferramentas de código de IA (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) a mais de 40 provedores de IA e mais de 100 modelos.**
  ...
  [![Docker Pulls](https://img.shields.io/docker/pulls/freezeraize-star/9router.svg?logo=docker&label=Docker%20pulls)](https://hub.docker.com/r/freezeraize-star/9router)
  [![GHCR](https://img.shields.io/badge/GHCR-freezeraize-star%2F9router-blue?logo=github)](https://github.com/freezeraize-star/9router/pkgs/container/9router)
  [![Licença](https://img.shields.io/npm/l/9router.svg)](https://github.com/freezeraize-star/9router/blob/main/LICENSE)
...
> 🎬 **Fez um vídeo sobre o 9Router?** Envie um [Pull Request](https://github.com/freezeraize-star/9router/pulls) adicionando seu vídeo a esta seção - nós o mesclaremos!
...
- Hub Docker: [`freezeraize-star/9router`](https://hub.docker.com/r/freezeraize-star/9router)
- GHCR: [`ghcr.io/freezeraize-star/9router`](https://github.com/freezeraize-star/9router/pkgs/container/9router)
...
docker run -d \
  ...
  -e DATA_DIR=/app/data \
  freezeraize-star/9router:latest
```
...
docker pull freezeraize-star/9router:latest   # atualizar para a versão mais recente
```
...
- **Issues**: [github.com/freezeraize-star/9router/issues](https://github.com/freezeraize-star/9router/issues)
...
[![Contribuidores](https://contrib.rocks/image?repo=freezeraize-star/9router&max=150&columns=15&anon=1&v=20260309)](https://github.com/freezeraize-star/9router/graphs/contributors)

---

## 📊 Gráfico de estrelas

[![Gráfico de estrelas](https://starchart.cc/freezeraize-star/9router.svg?variant=adaptive)](https://starchart.cc/freezeraize-star/9router)
