<div align="center">
  ...
  **Connectez tous vos outils de codage IA (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) à plus de 40 fournisseurs d'IA et plus de 100 modèles.**
  ...
  [![License](https://img.shields.io/npm/l/9router.svg)](https://github.com/freezeraize-star/9router/blob/main/LICENSE)
...
> 🎬 **Vous avez réalisé une vidéo sur 9Router ?** Envoyez une [Pull Request](https://github.com/freezeraize-star/9router/pulls) en ajoutant votre vidéo à cette section — nous la fusionnerons !
...
- Docker Hub : [`freezeraize-star/9router`](https://hub.docker.com/r/freezeraize-star/9router)
...
docker pull freezeraize-star/9router:latest   # mise à jour vers la dernière version
```
...
- **Problèmes** : [github.com/freezeraize-star/9router/issues](https://github.com/freezeraize-star/9router/issues)
...
[![Contributors](https://contrib.rocks/image?repo=freezeraize-star/9router&max=150&columns=15&anon=1&v=20260309)](https://github.com/freezeraize-star/9router/graphs/contributors)
